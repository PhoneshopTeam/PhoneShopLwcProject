...
export default class ItemBasket extends LightningElement {
    ...
    handleQuantity(event) {
        ...
        if(this.quantityItem > this.totalQuantityValue ){
            ...
            editQuantity({basketId: this.basketId, quantity : this.quantityItem})
    ...
    handleCheckbox(event) {
        ...
        if(this.checkboxValue===false){
            ...
            editCheckboxValue({basketId: this.basketId, checkbox: this.checkboxValue})
    ...
    fireEvent() {
        const orderButton = new CustomEvent('button', {detail: this.disabled     
        });                             
    ...
    handleDeleteClick() {
        deleteBasket({basketId : this.basketId}) 
        .then(result => {
